...
<div class="row">
    <div class="col-md-4">
       <h2>Nie chcę</h2>
        <ol id="components_no" data-draggable="target">

        </ol>
    </div>
    <div class="col-md-4">
       <h2>Opcionalnie</h2>
        <ol id="components_opcional" data-draggable="target">
           @foreach($components as $component)
            <li value="{{$component->id}}" data-draggable="item">{{$component->name}} {{$component->id}}</li>
            @endforeach
        </ol>
    </div>
    <div class="col-md-4">
       <h2>Chcę</h2>
        <ol id="components_yes" data-draggable="target">
        </ol>
    </div>
</div>

<button type="button" id="components_btn" class="btn btn-primary">Filtruj</button>

<!-- Modal -->
<div class="modal fade" id="popup-pizzerias" tabindex="-1">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Najlepiej dobrane pizzerie</h5>
